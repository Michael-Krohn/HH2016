...
python generalTreeAnalyzer_76X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/ --outName=WZ --trigger=False --jets=True --deta=True --isMC=True --xsec=47.13 --min=0 --max=1 --file=WZ_Skimmed.txt

xrdcp WZ_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/miniTrees/
