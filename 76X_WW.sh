...
python generalTreeAnalyzer_76X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/ --outName=WW --trigger=False --jets=True --deta=True --isMC=True --xsec=63.21 --min=0 --max=1 --file=WW_Skimmed.txt

xrdcp WW_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/miniTrees/
