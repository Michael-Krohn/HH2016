...
python generalTreeAnalyzer_76X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/ --outName=WQQ --trigger=False --jets=True --deta=True --isMC=True --xsec=95.14 --min=0 --max=1 --file=WQQ_Skimmed.txt

xrdcp WQQ_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/miniTrees/
