...
python generalTreeAnalyzer_76X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/ --outName=ZZ --trigger=False --jets=True --deta=True --isMC=True --xsec=16.523 --min=0 --max=1 --file=ZZ_Skimmed.txt

xrdcp ZZ_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/miniTrees/
