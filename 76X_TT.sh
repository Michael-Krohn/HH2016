...
python generalTreeAnalyzer_76X.py --pathIn=root://cmsxrootd.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/ --outName=TT --trigger=False --jets=True --deta=True --isMC=True --xsec=831.76 --min=0 --max=1 --file=TT_Skimmed.txt

xrdcp TT_0.root root://cmseos.fnal.gov//store/user/mkrohn/HHTo4b/SkimmedHeppy_nTuples/miniTrees/
